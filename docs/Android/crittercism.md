...
Return True if the current opt-in state allows reporting Omnissa Intelligence SDK data for the specified telemetry type.

### setOptInStatus (telemetryType, isOptedIn)

If you wish to offer your users the ability to opt out of Omnissa Intelligence SDK’s reporting, you can set the OptInStatus for TelemetryType ‘Application’ to false. There will be no information/requests sent from that user’s app. If you do so, any pending crash reports will be purged.

If you wish to offer your users the ability to opt out of Omnissa Intelligence SDK’s DEX Telemetry reporting, you can set the OptInStatus for TelemetryType ‘DEX’ to false. No more device information will be sent from that user’s app.
...
set to False to disable Omnissa Intelligence SDK’s reporting for the specified TelemetryType
