...
Once this object is setup, you can pass it to `+[WS1Intelligence enableWithConfig:]` or `WS1Intelligence.enable(with:)`. After Omnissa Intelligence SDK is enabled, changes to this object will have no effect.
